...
- `src/lib/client/` contains browser behavior and UI. Its project session owns live synchronization and local history selection; the timeline, artifact editor, and visualization player are consumer views over that session.
